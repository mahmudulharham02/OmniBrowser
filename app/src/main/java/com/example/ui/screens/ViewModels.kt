...
class SettingsViewModel(val settingsDataStore: SettingsDataStore) : ViewModel() {
    ...
    val lockIncognitoTabs = settingsDataStore.lockIncognitoTabs.stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), false)
    ...
    fun setLockIncognitoTabs(enabled: Boolean) = viewModelScope.launch { settingsDataStore.setLockIncognitoTabs(enabled) }
}
